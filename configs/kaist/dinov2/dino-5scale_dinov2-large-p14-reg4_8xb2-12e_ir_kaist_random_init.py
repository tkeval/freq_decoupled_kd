...
# ------------------------------------------------------------
# usage: bash ./tools/dist_train.sh dino-5scale_dinov2-large-p14-reg4_8xb2-12e_ir_kaist_random_init 4 --work-dir work_dirs/dino-5scale_dinov2-large-p14-reg4_8xb2-12e_ir_kaist_random_init
_base_ = [
...
param_scheduler = [
    ...
    dict(type='CosineAnnealingLR', by_epoch=True, begin=0, end=24, eta_min=1e-6)
]
