...
# -------------------------------------------------------------------------
# Dataset: ConcatDataset (KAIST + FLIR + MFNet)
# -------------------------------------------------------------------------
# Stage 1 only needs paired IR/RGB images (no detection annotations used).
# KAIST: ~25k paired images  |  FLIR Aligned: ~4.1k  |  MFNet: ~784
#
# IR/RGB mapping (all 3 datasets follow same convention):
#   file_name  → img_path  (RGB)  → after prepare_data swap → img2_path (teacher)
#   file_name2 → img2_path (IR)   → after prepare_data swap → img_path  (student)
...
# -------------------------------------------------------------------------
work_dir = './work_dirs/stage1_freq_decoupled'
